...
export default function Reviews() {
  return (
    <section className='min-vh-100 bg-light' style={{ backgroundImage: `url(${background})`}}>
      <div className="container-fluid text-dark text-center p-lg-5 reviews">
        ...
        <div className='container-fluid d-flex flex-column flex-lg-row justify-content-center align-items-center align-items-lg-start my-5'>
          ...
          <ul className='reviews col-12 col-sm-10 col-md-8 col-lg-5 ms-lg-5 testimonials'>
            <li className='bg-gradient d-flex flex-column  flex-lg-row justify-content-center justify-content-lg-between align-items-center text-lg-start shadow p-3 mb-5 rounded'>
            ...
            <li className='bg-gradient d-flex flex-column  flex-lg-row justify-content-center justify-content-lg-between align-items-center text-lg-start shadow p-3 mb-5 rounded'>
              ...
              <div className='ms-3'>
                <p className='fst-italic fs-5 mt-2'>"Beautiful locations! Excellent support staff. Fantastic!"</p>
